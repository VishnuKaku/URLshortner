...
import { IOverallAnalytics, IAnalyticsDocument, IOSStats, IDeviceStats } from '../../models/interfaces';
import AnalyticsModel from '../../models/Analytics';

export class OverallAggregator {
  public async aggregate(userId: string, startDate: Date, endDate: Date): Promise<IOverallAnalytics> {
